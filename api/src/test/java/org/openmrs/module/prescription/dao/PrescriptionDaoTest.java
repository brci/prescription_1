 ...
 */
package org.openmrs.module.prescription.dao;
 ...
 */
public class PrescriptionDaoTest extends BaseModuleContextSensitiveTest {
	...
	public void saveItem_shouldSaveAllPropertiesInDb() {
		...
		// Then
		Prescription savedItem = dao.getItemByUuid(item.getUuid());
